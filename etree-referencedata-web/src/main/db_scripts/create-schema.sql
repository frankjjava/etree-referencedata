psql referencedata_db referencedata_tbls_user

CREATE SCHEMA referencedata_tbls;

GRANT USAGE ON SCHEMA referencedata_tbls TO referencedata_user;

GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA referencedata_tbls TO referencedata_user;

GRANT USAGE, SELECT, UPDATE ON ALL SEQUENCES IN SCHEMA referencedata_tbls TO referencedata_user;

ALTER DEFAULT PRIVILEGES IN SCHEMA referencedata_tbls GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO referencedata_user;

ALTER DEFAULT PRIVILEGES IN SCHEMA referencedata_tbls GRANT USAGE, SELECT, UPDATE ON SEQUENCES TO referencedata_user;
